        ...
        <div class="auto-container">
            <div class="inner-container clearfix">
                ...
                <div class="pull-left logo-box">
                    <div class="logo">
                        <a href="/">
                            <img src="<?= HelperFunction::getMedia(HelperFunction::setting('logo_header')) ?>"
    ...
    <div class="mobile-menu">
        ...
        <nav class="menu-box">
            <div class="nav-logo"><a href="/"><img
                            src="<?= HelperFunction::getMedia(HelperFunction::setting('logo_header')) ?>"
                            alt="<?= HelperFunction::setting('site_name') ?>"></a></div>
